...
class OpenAirLoginPage:
    ...
    async def click_sign_in(self):
        print("Clicking 'Sign In' on OpenAir SSO...")
    ...
    async def click_ms_next(self):
        print("Clicking 'Next' on Microsoft login...")
    ...
    async def click_valtech_sign_in(self):
        print("Clicking 'Sign In' on Valtech login...")
    ...
    async def get_mfa_code(self):
        ...
        try:
            ...
            print(f"MFA Code displayed on screen: {code}")
            ...
            print("MFA code not found (may be skipped or redirected).")
            return "N/A"
